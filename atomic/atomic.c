...
function inline b32 Atomic_Compare_Exchange_B32(atomic_b32* Atomic, b32 OldValue, b32 NewValue) {
	return (b32)Atomic_Compare_Exchange_S32(&Atomic->Internal, OldValue, NewValue);
}

function inline void* Atomic_Load_Ptr(atomic_ptr* Atomic) {
#ifdef USE_32_BIT
...
function inline void Atomic_Store_Ptr(atomic_ptr* Atomic, void* Ptr) {
#ifdef USE_32_BIT
...
function inline void* Atomic_Compare_Exchange_Ptr(atomic_ptr* Atomic, void* OldPtr, void* NewPtr) {
#ifdef USE_32_BIT
